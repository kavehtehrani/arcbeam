      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="mb-1 text-xs font-medium text-gray-500">USDC</p>
              <p className="text-xl font-semibold text-gray-900">0.00</p>
            </div>
            <div>
              <p className="mb-1 text-xs font-medium text-gray-500">ETH</p>
              <p className="text-xl font-semibold text-gray-900">0.0000</p>
            </div>
          </div>
        </div>
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-gray-900">Base Sepolia</p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="mb-1 text-xs font-medium text-gray-500">USDC</p>
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 opacity-60">
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-gray-500">Arc Testnet</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <p className="mb-1 text-xs font-medium text-gray-500">ETH</p>
              <p className="text-xl font-semibold text-gray-500">0.0000</p>
            </div>
          </div>
        </div>
      </div>
